...
public class SearchJob extends ProjectSpecificMethods {
	public String strtestdatafilename = "UiTestData";
	JSONObject jsonsuitetestData = JsonComponent.getJsonData("suiteLevelData", strtestdatafilename);

	@BeforeTest
	public void setValues() {
		testSuiteName = "SearchJob";
	...
	@Test
	public void TC001_verify_user_is_able_to_search_the_job_inJobPage() throws InterruptedException {
		String testName = "TC001_verify_user_is_able_to_search_the_job_inJobPage";
		...
		try {
			...
			jobpage.searchJob(jobtitle);
			Assert.assertEquals(jobpage.validateFirstJobNameAdded(), jobtitle);
			reportStep("JobTitle :" + jobtitle + "displayed after searching with job title", "pass");
			updateTestRailResultAsPass("284363");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("284363");
