...
public class JobTargetIntegrationsInJobPage extends ProjectSpecificMethods {
	public String strtestdatafilename = "UiTestData";
	JSONObject jsonsuitetestData = JsonComponent.getJsonData("suiteLevelData", strtestdatafilename);

	@BeforeTest
	public void setValues() {
		testSuiteName = "Job Target Integrations";
	...
	@Test
	public void TC001_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_careerbuilder_in_jobtargetpage(){
		String testName = "TC001_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_careerbuilder_in_jobtargetpage";
		...
		try {
			...
			updateTestRailResultAsPass("303910");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("303910");
			Assert.fail(e.getMessage());
		}
	}
	@Test
	public void TC002_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_LinkedIn_in_jobtargetpage(){
		String testName = "TC002_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_LinkedIn_in_jobtargetpage";
		...
		try {
			...
			Assert.assertEquals(jobtargettext, siteName);
			reportStep("Job published by adding "+ siteName +" as jobtarget Successfully", "pass");
			updateTestRailResultAsPass("304344");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("304344");
			Assert.fail(e.getMessage());
		}
	}
	
	@Test
	public void TC003_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_monstor_in_jobtargetpage(){
		String testName = "TC003_verify_user_is_able_to_publish_the_job_by_adding_sitename_as_monstor_in_jobtargetpage";
		...
		try {
			...
			Assert.assertEquals(jobtargettext, siteName);
			reportStep("Job published by adding "+ siteName +" as jobtarget Successfully", "pass");
			updateTestRailResultAsPass("304561");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("304561");
			Assert.fail(e.getMessage());
		}
	}
}
