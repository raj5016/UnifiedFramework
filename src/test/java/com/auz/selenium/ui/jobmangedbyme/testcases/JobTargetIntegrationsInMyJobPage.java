...
public class JobTargetIntegrationsInMyJobPage extends ProjectSpecificMethods {
	...
	@Test
	public void TC001_verify_user_is_able_to_publish_the_job_in_myjobpage_by_adding_sitename_as_careerbuilder_in_jobtargetpage(){
		String testName = "TC001_verify_user_is_able_to_publish_the_job_in_myjobpage_by_adding_sitename_as_careerbuilder_in_jobtargetpage";

		// setting Report data
		reportUpdate(testName);

		HomePage homePage = new HomePage(driver, test);
		JobsManagedByMe myjobpage = new JobsManagedByMe(driver, test);
		PostJobPage postJobPage = new PostJobPage(driver, test);
		...
		try {
			...
			myjobpage.clickAddNewJobInJobManagedByme();
			...
			updateTestRailResultAsPass("304570");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("304570");
			Assert.fail(e.getMessage());
		}
	}
	@Test
	public void TC002_verify_user_is_able_to_publish_the_job_in_myjobpage_by_adding_sitename_as_LinkedIn_in_jobtargetpage(){
		String testName = "TC002_verify_user_is_able_to_publish_the_job_in_myjobpage_by_adding_sitename_as_LinkedIn_in_jobtargetpage";
		...
		try {
			...
			Assert.assertEquals(jobtargettext, siteName);
			reportStep("Job published by adding "+ siteName +" as jobtarget Successfully", "pass");
			updateTestRailResultAsPass("304579");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("304579");
			Assert.fail(e.getMessage());
		}
	}
	...
	public void TC003_verify_user_is_able_to_publish_the_job_in_myjobpage_by_adding_sitename_as_monstor_in_jobtargetpage(){
		...
		try {
			...
			Assert.assertEquals(jobtargettext, siteName);
			reportStep("Job published by adding "+ siteName +" as jobtarget Successfully", "pass");
			updateTestRailResultAsPass("304588");
		} catch (Exception e) {
			test.log(Status.ERROR, "StackTrace Result: " + e);
			reportStep("Test Case Not executed Successfully", "fail");
			updateTestRailResultAsFail("304588");
			Assert.fail(e.getMessage());
		}
	}
}
