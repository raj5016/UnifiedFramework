...
public class JobsManagedByMe extends ProjectSpecificMethods {

	public JobsManagedByMe(RemoteWebDriver driver, ExtentTest test) {
		this.driver = driver;
		this.test = test;
	...
	public void selectPublishedJobInJobMangedByMe() throws InterruptedException {
		wait = new WebDriverWait(driver, 60);
	...
	public String getPublishedJobCountInJobMangedByMe() throws InterruptedException {
		wait = new WebDriverWait(driver, 60);
	...
	public void clickAddNewJobInJobManagedByme() {
			waitForElementLoad(2000);
			click(eleAddNewJob, "AddNewJob");
	}
	public String validateFirstJobNameAddedInJobManagedByMePage() {
	...
	public void movecandidateTodifferentStages() {
		WebElement sourceOfSourcingStageelement=driver.findElement(By.xpath("//body/div[@id='hireApp']/div/section/section/main/section/div/main/div/div/div/div/div[1]"));
		WebElement targetOfApplyStageelement=driver.findElement(By.xpath("//body/div[@id='hireApp']/div/section/section/main/section/div/main/div/div[2]/div[1]"));
